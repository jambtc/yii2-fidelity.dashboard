			...
			<tbody>
				<tr>
					<td style="font-family:Roboto,Tahoma,Verdana,Segoe,sans-serif; color: #555; font-size: 14px;" valign="top">
						<div>
							<p style="font-size:34px;color:rgb(57,150,220)"><?php echo Yii::t('app','Merchant account');?></p>
						</div>
						<div>
						...
						<div>
							<p style="margin-top: 28px;font-size: 14px;"><?php echo Yii::t('app','your merchant account was created.');?>
				          	<br>
